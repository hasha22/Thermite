...
public class ThermBlocks {
    ...
    public static final FireplaceBlock FIREPLACE_BLOCK = new FireplaceBlock(FabricBlockSettings.create().strength(3.5f).luminance(state -> state.get(FireplaceBlock.LIT) != false ? 15 : 0));
