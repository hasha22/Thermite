...
public class ThermBlocks {
    ...
    //UPDATE - Hasha
    // Made fireplace block unmineable
    public static final FireplaceBlock FIREPLACE_BLOCK = new FireplaceBlock(FabricBlockSettings.create().strength(1000000000f).luminance(state -> state.get(FireplaceBlock.LIT) != false ? 15 : 0));
